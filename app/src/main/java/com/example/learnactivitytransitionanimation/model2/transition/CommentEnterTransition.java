...
public class CommentEnterTransition extends Visibility {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        Log.e(TAG, "captureStartValues transitionValues=" + transitionValues);
        ...
        transitionValues.values.put(PROPNAME_TOP_BAR_TRANSITION_Y, -144);
    }
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        Log.w(TAG, "createAnimator startValues=" + startValues+"\nendValues="+endValues);

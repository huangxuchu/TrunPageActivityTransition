...
public class ShareElemEnterRevealTransition extends Transition {
    private static final String TAG = "ShareElemEnterReveal";
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        int halfWidth = transitionValues.view.getWidth() / 2;
        transitionValues.values.put(PROPNAME_RADIUS, halfWidth);
        Log.i(TAG, "captureStartValues halfWidth=" + halfWidth);
    }
    ...
    public void captureEndValues(TransitionValues transitionValues) {
        ...
        Log.i(TAG, "captureEndValues radius=" + radius);
    }
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (endView == animView) {
            Animator reveal = createAnimator(endView, startRadius, endRadius);
            hasAnim = true;
            Log.i(TAG, "startView=" + startView + " endView=" + endView
